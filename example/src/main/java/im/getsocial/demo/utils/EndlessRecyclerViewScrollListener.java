...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
	...
	public EndlessRecyclerViewScrollListener(final StaggeredGridLayoutManager layoutManager) {
		mLayoutManager = layoutManager;
		visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
	}
	...
	public void onScrolled(final RecyclerView view, final int dx, final int dy) {
		...
		if (mLayoutManager instanceof StaggeredGridLayoutManager) {
			final int[] lastVisibleItemPositions = ((StaggeredGridLayoutManager) mLayoutManager).findLastVisibleItemPositions(null);
