    ...
    protected List<MenuItem> createListData() {
        return Arrays.asList(
                ...
                MenuItem.builder("Group Activity Details (504205474833540031)")
                        ...
                        .build(),
                MenuItem.builder("All app mentions")
                        .withAction(new MenuItem.Action() {
                            @Override
                            public void execute() {
                                ActivityFeedViewBuilder.create(ActivitiesQuery.everywhere().withMentions(
                                        Collections.singletonList(UserId.createForApp()))
                                ).show();
                            }
                        })
                        .build(),
                MenuItem.builder("All bookmarked")
                        .withAction(new MenuItem.Action() {
                            @Override
                            public void execute() {
                                addContentFragment(FeedFragment.bookmarkedActivities());
                            }
                        })
                        .build(),
                MenuItem.builder("All reacted activities")
                        .withAction(new MenuItem.Action() {
                            @Override
                            public void execute() {
                                addContentFragment(FeedFragment.reactedActivities(null));
                            }
                        })
                        .build(),
                MenuItem.builder("All liked activities")
                        .withAction(new MenuItem.Action() {
                            @Override
                            public void execute() {
                                addContentFragment(FeedFragment.reactedActivities("like"));
                            }
                        })
                        .build(),
                MenuItem.builder("All voted activities")
                        .withAction(new MenuItem.Action() {
                            @Override
                            public void execute() {
                                addContentFragment(FeedFragment.votedActivities());
                            }
                        })
                        .build()
        );
            ...
            builder.setCustomErrorMessageProvider(new CustomErrorMessageProvider() {
                ...
                public String onError(int errorCode, String errorMessage) {
                    if (errorCode == ErrorCode.ACTIVITY_REJECTED) {
                        return "Be careful with what you say :)";
                    }
                    return errorMessage;
                }
            });
