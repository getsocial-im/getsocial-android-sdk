...
public class MessageListAdapter extends RecyclerView.Adapter<MessageListAdapter.ViewHolder> {
	...
	public MessageListAdapter(final List<GetSocialActivity> items) {
		_items = items;
	...
	public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
		final RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) viewHolder._messageText.getLayoutParams();
